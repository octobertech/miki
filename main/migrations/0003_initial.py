...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'main_profile_follows')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_profile', models.ForeignKey(orm[u'main.profile'], null=False)),
            ('to_profile', models.ForeignKey(orm[u'main.profile'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'main_profile_follows'))
    ...
    models = {
        ...
        u'main.profile': {
            ...
            'follows': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "u'followed_by'", 'symmetrical': 'False', 'to': u"orm['main.Profile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
